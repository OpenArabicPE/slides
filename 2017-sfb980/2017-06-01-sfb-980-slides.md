...
## 3.2.3 advantages of Linked Open Data

If an entity can be linked to an online authority file (i.e. Linked Open Data (LOD)), they will provide further information:
...
- Proposed solution: 
    + use canonnical references to printed sources such as biographical dictionaries, union catalogues etc.
    ...
    + Potential canonical reference: `oclc_618896732-pb_340-cb_781-div_2`
