...
![Search in [ZDB](https://zdb-katalog.de/list.xhtml?t=الجنة) for "[الجنة]{lang="ar"}"](../assets/zdb_janna-ar-Latn.png){#fig:zdb-ar}
...
the title is an allusion to Moritz Feichtinger's talk at a conference earlier this year
